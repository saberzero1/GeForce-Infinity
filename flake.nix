{
  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      in
      {
        ...
        checks = {
          ...
          module-eval-test =
            pkgs.runCommand "test-module-evaluation"
              {
    ...
    // {
      ...
      lib = {
        generateGeForceInfinityConfig =
          settings: pkgs:
          let
            settingsFormat = pkgs.formats.json { };
          in
          settingsFormat.generate "geforce-infinity-settings.json" {
            ...
            }
            {
              assertion =
                let
                  ...
                  isValid = any (
                    combo:
                    combo.width == cfg.settings.resolution.width && combo.height == cfg.settings.resolution.height
                  ) validCombinations;
                in
                isValid;
              message = ''
